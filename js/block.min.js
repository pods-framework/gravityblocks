		...
		_createClass(edit, [{
			...
			value: function updateFormPreview(attributes) {
				...
				window.fetch(apiURL).then(function (response) {
					...
					response.json().then(function (obj) {
						...
						if (obj.success) {
							_this2.setState({ html: obj.data.scripts + obj.data.html });
						} else {
			...
			value: function render() {
				...
				var _props$attributes = this.props.attributes,
				    ...
				    hidePreview = _props$attributes.hidePreview;
				...
				var toggleHidePreview = function toggleHidePreview() {
					return setAttributes({ hidePreview: !hidePreview });
				};
				...
				return [controls, wp.element.createElement(
					...
					wp.element.createElement(SandBox, { html: html, type: 'html' })
				)];
			}
		}]);
