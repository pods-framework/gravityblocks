...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_sandbox__ = __webpack_require__(1);
...
registerBlockType('gravityforms/block', {
	...
	title: 'Gravity Forms',
	icon: function icon() {
		return wp.element.createElement('img', { src: gform.icon, height: '20' });
	},
	category: 'embed',
	supports: {
	...
	edit: function (_Component) {
		...
		_createClass(edit, [{
			...
			value: function updateFormPreview(attributes) {
				...
				var apiURL = wpApiSettings.root + 'gf/v2/block/preview?formId=' + formId + '&title=' + (title ? title : false) + '&description=' + (description ? description : false) + '&ajax=' + (ajax ? ajax : false);
			...
			value: function render() {
				...
				if (!html || !formPreview) {
					...
					return [controls, wp.element.createElement(
						...
						wp.element.createElement(
							...
							wp.element.createElement('img', { src: gform.icon, width: '110' }),
							wp.element.createElement(
								'p',
								null,
								wp.element.createElement(
				...
				return [controls, wp.element.createElement(
					...
					wp.element.createElement(__WEBPACK_IMPORTED_MODULE_0__components_sandbox__["a" /* default */], { html: html, onFocus: function onFocus() {
							return setFocus();
						} })
				)];
			}
