		...
		_createClass(edit, [{
			...
			value: function render() {
				...
				var toggleConditionalLogic = function toggleConditionalLogic() {
					return setAttributes({ conditionalLogic: _extends({}, conditionalLogic, { enabled: !conditionalLogic.enabled }) });
				};
				...
				var updateConditionalLogic = function updateConditionalLogic(logic) {
					setAttributes({ conditionalLogic: _extends({}, conditionalLogic, logic) });
				};
