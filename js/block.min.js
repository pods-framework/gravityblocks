...
registerBlockType('gravityforms/block', {
	...
	edit: function edit(props) {
		...
		), (!!props.focus || !props.attributes.id) && wp.element.createElement(
			Placeholder,
			{ key: 'placeholder', className: 'wp-block-embed', label: __('Select a Form', 'gravityforms') },
			wp.element.createElement(
				'form',
				null,
				wp.element.createElement(
					'select',
					{ value: props.attributes.id, onChange: onChangeFormPreview },
					formOptions
				)
			)
		), !props.focus && props.attributes.id && wp.element.createElement(
