			...
			value: function render() {
				...
				var controls = [focus && React.createElement(
					...
					React.createElement(
						...
						React.createElement(__WEBPACK_IMPORTED_MODULE_1__components_conditional_logic___["a" /* default */], { logic: conditionalLogic, onChange: updateConditionalLogic })
					),
					React.createElement(
						PanelBody,
...
var LogicControl = function (_Component) {
	...
	_createClass(LogicControl, [{
		...
		value: function render() {
			...
			var changeRules = function changeRules(rules) {} /*this.props.onChange( { rules: rules } ); */
...
var Ruleset = function (_Component) {
	...
	_createClass(Ruleset, [{
		...
		value: function deleteRule(index) {
			...
			var rules = this.getRules();
			var newRules = rules.splice(index, 1);
		...
		value: function render() {
			...
			if (rules.length > 0) {
				rulesNodes = rules.map(function (rule, index) {
					return React.createElement(__WEBPACK_IMPORTED_MODULE_0__rule___["a" /* default */], { rule: rule, index: index, onChange: _this2.updateRule,
						onDelete: _this2.deleteRule });
				});
			}

			return [rulesNodes, React.createElement(IconButton, {
				icon: 'insert',
				label: __('Add Rule'),
				onClick: addRule,
